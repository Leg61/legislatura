...
<head>
	...
	<meta name="description" content="Conoce a las/os Diputadas/os que integran la LXI Legislatura del Estado de México.">
	<meta property="og:description" content="Conoce a las/os Diputadas/os que integran la LXI Legislatura del Estado de México." />
	...
	<title>Diputadas y Diputados | LXI Legislatura</title>
...
<div align="center">	
	...
	<div id="contenido">
		<div id="contenido_left">
			...
			$query  = "SELECT * FROM cdd_diputados_lxi WHERE status = 'activo' ORDER BY apaterno ASC, amaterno ASC, nombres ASC";
			...
			<div style="font-family: 'Arimo', sans-serif;font-weight: 300;">
				...
				<div style="text-align: center; width: 140px; float: left;">
					<div style="background: linear-gradient( 90deg, rgb(<? echo $partido['rgb']; ?>,1.00) 0%, rgb(<? echo $partido['rgb2']; ?>,1.00) 100% ); height: 130px; width: 130px; border-radius: 50%; padding: 5px; float: left;">
						<div style="background: rgba(255,255,255); border-radius: 50%; height: 130px; width: 130px;">
							<div style="background: url(img/fotos/dip/lxi/<? echo $row['foto']; ?>) no-repeat; background-size: 130px; width: 130px; height: 130px; float: left; border-radius:50%;"></div>
