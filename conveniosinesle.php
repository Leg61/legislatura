...
<head>
	...
	<meta property="og:title" content="Convenios INESLE" />

	<link rel="icon" type="image/png" href="favicon.svg">	
	<link href="style.css" rel="stylesheet" type="text/css">
	<link href="css/menu.css" rel="stylesheet" type="text/css">
	
	<title>Convenios INESLE</title>
...
<div align="center">	
	...
	<div id="contenido">
		<div style="width: 100%; max-width: 688px; margin: 0px 20px; float: left; text-align: justify;">
			<h1>Convenios INESLE</h1>
			<?
			$connect = new TConeccion();
			$query  = "SELECT * FROM inesle_convenios ORDER BY date DESC";
			...
			<p style="border-bottom: rgb(135,135,135) dotted 1px;">
				<a href="../documentos/inesle/convenios/<? echo $row['pdf']; ?>" target="_blank"><i class="far fa-file-pdf"></i> <b><? echo utf8_encode($row['title']); ?></b></a><br>
