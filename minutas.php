...
<head>
	...
	<meta property="og:title" content="Minutas del H. Congreso de la Unión" />

	<link rel="icon" type="image/png" href="favicon.svg">
	<link href="style.css" rel="stylesheet" type="text/css">
	<link href="css/menu.css" rel="stylesheet" type="text/css">
	
	<title>Minutas del H. Congreso de la Unión</title>
...
<div align="center">	
	...
	<div id="contenido">
		...
		<!--<div style="width: 100%; max-width: 688px; margin: 0px 20px; float: left; text-align: justify;">-->
			<h1>Minutas del H. Congreso de la Unión</h1>
			...
			<h2>Minutas del H. Congreso de la Unión recibidas durante la LXI Legislatura</h2>
			
			<?
			$counter = 0;
			$connect = new TConeccion();
			$query  = "SELECT * FROM cdd_iniciativas WHERE categoria = 'Minuta' ORDER BY presentada DESC";
			...
			<p style="border-bottom: rgb(135,135,135) dotted 1px;">
				<? if ($counter == 0) { echo "No se encontraron resultados para esta categoría"; } ?>
