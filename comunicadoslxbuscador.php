...
<head>
	...
	<title>Comunicados LX Legislatura</title>
...
<div align="center">	
	...
	<div style="width: 100%; max-width: 1260px; margin: auto; padding-top: 202px;">
		...
		<div style="width: 100%; float: left; margin:10px; display: block; text-align: justify;">
			...
			$termino = utf8_decode($_GET['tema']);
			$Coneccion = new TConeccion();
			$query  = "SELECT * FROM cdd_comunicados_lx WHERE titulo LIKE '%".$termino."%' OR bullet1 LIKE '%".$termino."%' OR bullet2 LIKE '%".$termino."%' OR bullet3 LIKE '%".$termino."%' OR texto LIKE '%".$termino."%' ORDER BY comunicado DESC";
			$Coneccion->Gestion($query);
