...
<head>
	...
	<meta property="og:title" content="Puntos de acuerdo" />

	<link rel="icon" type="image/png" href="favicon.svg">
	<link href="style.css" rel="stylesheet" type="text/css">
	<link href="css/menu.css" rel="stylesheet" type="text/css">
	
	<title>Puntos de acuerdo</title>
...
<div align="center">	
	...
	<div id="contenido">
		...
		<!--<div style="width: 100%; max-width: 688px; margin: 0px 20px; float: left; text-align: justify;">-->
			...
			<h2>Puntos de acuerdo presentados durante la LXI Legislatura</h2>
			
			<?
			$connect = new TConeccion();
			$query  = "SELECT * FROM cdd_iniciativas WHERE categoria = 'Punto de Acuerdo' ORDER BY presentada DESC";
